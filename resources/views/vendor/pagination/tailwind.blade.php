...
<nav role="navigation" aria-label="{{ __('Pagination Navigation 11') }}" class="space-y-3 md:space-y-0 p-0">
    <div class="flex justify-between flex-1 sm:hidden">
        ...
        <button wire:click="previousPage" wire:loading.attr="disabled"
            class="flex text-sm items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            {!! __('pagination.previous') !!}
        </button>
            ...
            <ul class="inline-flex items-stretch -space-x-px">
                ...
                <li>
                    <button
                        ...
                        <svg class="w-5 h-5 opacity-60" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                ...
                <li aria-current="page" wire:key="paginator-page-{{ $page }}">
                    <button
                        class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-gray-500 bg-gray-200 border border-gray-300  hover:bg-primary-100 hover:text-primary-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">{{
                        $page }}</button>
                </li>
                @else
