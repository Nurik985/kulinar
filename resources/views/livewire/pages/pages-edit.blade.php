    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl">
            <div class="bg-white dark:bg-gray-800 relative border rounded-[4px] overflow-hidden">
                <form wire:submit="updatePage" class="p-4">
                    @csrf
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mb-5">
                        ...
                        <div wire:ignore class="sm:col-span-2">
                            ...
                            <textarea wire:model="text" id="editor" rows="8" name="text" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-[4px] border border-gray-300 focus:outline-none">{{ $text }}</textarea>
                        </div>
                    </div>
