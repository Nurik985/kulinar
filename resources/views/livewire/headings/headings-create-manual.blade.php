            ...
            <div class="px-6 py-6 lg:px-8">
                <form wire:submit="saveHeading" class="space-y-6">
                    <div class="grid gap-2 sm:grid-cols-2 sm:gap-4">
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Родительская рубрика</div>
                            <div class="div_mass">
                                <div class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-500">
                                    ...
                                    <input wire:keyup="rubricSearchFunc" wire:model="rubricSearchText" type="text" name="url" class="findRub inpt_text block w-full rounded-[4px] border-[#ccc] m-0 h-10 border-1 p-2 mt-2  text-sm text-gray-500">
                                </div>
                                <div class="relative">
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Родительский раздел</div>
                            <div class="div_mass">
                                <div class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-500">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                        @if($sectionSelecteds)
                                    ...
                                    <input wire:keyup="sectionSearchFunc" wire:model="sectionSearchText" type="text" name="url" class="findRub inpt_text block w-full rounded-[4px] border-[#ccc] m-0 h-10 border-1 p-2 mt-2  text-sm text-gray-500">
                                </div>
                                <div class="relative">
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Хлебные крошки</div>
                            <div class="div_mass">
                                <div class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-500">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                    ...
                                    <input wire:keyup="breadcrumbSearchFunc" wire:model="breadcrumbSearchText" type="text" name="url" class="findRub inpt_text block w-full rounded-[4px] border-[#ccc] m-0 h-10 border-1 p-2 mt-2  text-sm text-gray-500">
                                </div>
                                <div class="relative">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <label for="linkAddSection" class="ml-2 cursor-pointer text-sm font-medium text-gray-500 dark:text-gray-300">Добавить ссылку в раздел</label>
                        </div>
                        <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Рецепты</div>
                            <div class="div_mass">
                                <div class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-500">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                        @if($recipSelecteds)
                                    ...
                                    <input wire:keyup="recipSearchFunc" wire:model="recipSearchText" type="text" name="url" class="findRub inpt_text block w-full rounded-[4px] border-[#ccc] m-0 h-10 border-1 p-2 mt-2  text-sm text-gray-500">
                                </div>
                                <div class="relative">
