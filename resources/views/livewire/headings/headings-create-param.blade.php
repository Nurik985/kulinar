                    ...
                    <div class="grid gap-2 sm:grid-cols-2 sm:gap-4">
                        <div class="sm:col-span-2">
                            ...
                            <input wire:model.live="name" wire:keyup="generateSlug" type="text" name="name" id="name"
                                   class="@error('name') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-[4px] dark:bg-gray-700 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @enderror block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:outline-none">
                            @error('name')
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Что готовим</div>
                            <div class="div_mass">
                                <div  class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                        @if($cookSelecteds)
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Исключая игридиенты</div>
                            <div class="div_mass">
                                <div  class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                        @if($excIngrSelecteds)
                        ...
                        <div class="sm:col-span-2">
                            <div class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Способ приготовления</div>
                            <div class="div_mass">
                                <div  class="line-val block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                                    <div class="div-block-item flex flex-wrap gap-2 line-val">
                                        @if($methodSelecteds)
