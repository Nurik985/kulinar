            ...
            <div class="bg-white dark:bg-gray-800 relative border rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-3 text-center border border-gray-400 border-l-0">Гл.</th>
                            <th scope="col" class="px-4 py-3 border border-gray-400">
                            ...
                            <th scope="col" class="px-4 py-3 border border-gray-400">ЧПУ</th>
                            <th scope="col" class="px-4 py-3 border border-gray-400">Создан</th>
                        ...
                        @if(count($sections) > 0)
                            @foreach ($sections as $k => $section)
                                <tr wire:key="{{ $section->id }}"
                                    ...
                                    <td class="px-4 py-3 w-fit text-center">
                                        @if($section->fade_home == 'off')
                                            <i class="ti ti-award text-gray-300"></i>
                                        @else
                                            <i class="ti ti-award-filled text-green-500"></i>
                                        @endif
                                    </td>
                                    <td class="px-4 py-3 w-1/3 border">{{ $section->h1 }}</td>
                                    <td class="px-4 py-3 w-1/3 border">{{ $section->url }}</td>
                                    <td class="px-4 py-3 w-fit border">{{ $section->created_at->format('d-m-Y') }}</td>
