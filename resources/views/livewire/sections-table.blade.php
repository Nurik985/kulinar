<div>
    <section class="bg-white dark:bg-gray-900">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $section->id }}"
                                ...
                                <td class="px-4 py-3 w-1/3">{{ $section->h1 }}</td>
                                <td class="px-4 py-3 w-1/3 text-green-500">{{ $section->url }}</td>
                                <td class="px-4 py-3 w-1/3">{{ $section->created_at->format('d-m-Y') }}</td>
        ...
        <div wire:ignore id="delMod" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500  dark:text-gray-300">Вы точно хотите удалить раздел <br>
                        <span id="mTitle" class="text-lg font-medium"></span>?
                    </p>
