            ...
            <div class="px-6 py-6 lg:px-8">
                <form wire:submit="saveUnit" class="space-y-6">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            <label for="weight"
                                   class="@error('weight')text-red-700 dark:text-red-500 @enderror mb-2 block text-sm font-medium text-gray-900 dark:text-white">Грамм</label>
                            <input wire:model.live="weight" type="text" name="weight" id="weight"
                                   class="@error('weight') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-[4px] dark:bg-gray-700 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @enderror block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
                            @error('weight')
                            <p class="mt-1 text-xs text-red-600 dark:text-red-500"><span
                                    class="font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="sm:col-span-2">
                            <label for="form_word"
                                   class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Формы слова</label>
                            <input wire:model="form_word" type="text" name="form_word" id="form_word"
                                   class="block w-full rounded-[4px] border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="литр|литра|литров">
                            <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Слова подбираете для числительных 1|2|5.Пример 1 литр 2 литра и 5 литрова. Cоответсвтенно прописываете литр|литра|литров</p>
                        </div>
                    </div>
                    <div class="flex justify-between">
                        <div class="mr-4 flex justify-end">
                            <a href="{{ route('spisok.units.index') }}"
