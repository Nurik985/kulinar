    ...
    <div class="flex max-h-full w-full justify-center">
        <div class="w-full rounded-[4px] border bg-white dark:bg-gray-700">
            <div class="px-6 py-6 lg:px-8">
                <form wire:submit="updateNorm" class="space-y-6">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            <label for="value"
                                   class="@error('value')text-red-700 dark:text-red-500 @enderror mb-2 block text-sm font-medium text-gray-900 dark:text-white">Грамм</label>
                            <input wire:model.live="value" type="text" name="value" id="value"
                    ...
                    <div class="flex justify-between">
                        <div class="mr-4 flex justify-end">
                            <a href="{{ route('spisok.norms.index') }}"
