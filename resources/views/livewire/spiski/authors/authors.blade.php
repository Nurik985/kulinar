            ...
            <div class="relative overflow-hidden rounded-[4px] border bg-white dark:bg-gray-800">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            <th scope="col" class="border border-l-0 border-gray-400 px-4 py-3">Фото</th>
                            <th scope="col" class="border border-gray-400 px-4 py-3 text-xs">Имя</th>
                            <th scope="col" class="border border-gray-400 px-4 py-3 text-xs">Email</th>
                            <th scope="col" class="border border-gray-400 px-4 py-3 text-xs">Количество рецептов</th>
                            <th scope="col" class="border border-gray-400 px-4 py-3 text-xs">Валюта</th>
                                ...
                                <tr wire:key="{{ $author->id }}"
                                    ...
                                    <td class="w-fit px-4 py-3">
                                        <div class="flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler text-gray-500 icon-tabler-user-pentagon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <td class="flex w-fit items-center justify-end px-4 py-3">
                                        ...
                                        <span wire:click="openDelModal({{ $author->id }}, '{{ $author->name }}')"
