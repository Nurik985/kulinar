            ...
            <div class="relative overflow-hidden rounded-[4px] border bg-white dark:bg-gray-800">
                <div
                    ...
                    <div
                        ...
                        <a href="{{ route('spisok.portions.create') }}"
                            ...
                            @foreach ($portions as $k => $portion)
                                <tr wire:key="{{ $portion->id }}"
                                    ...
                                    <td class="flex w-fit items-center justify-end px-4 py-3">
                                        ...
                                        <span wire:click="openDelModal({{ $portion->id }}, '{{ $portion->name }}')"
