                                                ...
                                                @if (!empty($stepLists[$i]['img']))
                                                    <div class="flex flex-col justify-center items-center">
                                                        @foreach($stepLists[$i]['img'] as $imgKey => $img)
                                                            <div class="relative">
                                                                <img class="w-[140px] h-[140px] object-cover bg-gray-50 mb-2 border-2 border-black rounded-[4px]"  src="{{ $img ? asset($img) : $img->temporaryUrl()   }}">
                    ...
                    <div class="w-full">
                        ...
                        @if ($recipeImg)
                            <img class="w-[200px] h-[200px] object-cover relative block bg-gray-50 border border-gray-300 rounded-[4px]"
                                 src="{{ $temporaryUrl? $recipeImg->temporaryUrl() :  asset('storage/'.$recipeImg)  }}">
                        @else
                            <div
                        ...
                        <label class="cursor-pointer w-full text-sm font-lighr text-black dark:text-gray-300">
                            <div
                                ...
                                <input wire:click="statusChange(2)" id="status1" type="radio" value="1" name="status"
                                       class="w-4 h-4 text-green-700 bg-gray-100 border-gray-300 mr-2" @if($status == 2) checked @endif>
                                Черновик
                            </div>
                        </label>
                    </li>
                        ...
                        <label class="cursor-pointer w-full text-sm font-lighr text-black dark:text-gray-300">
                            <div
                                ...
                                <input wire:click="statusChange(1)" id="status2" type="radio" value="2" name="status"
                                       class="w-4 h-4 text-green-700 bg-gray-100 border-gray-300 mr-2" @if($status == 1) checked @endif>
                                Опубликовать
                            </div>
                        </label>
                    </li>
                        ...
                        <label class="cursor-pointer w-full text-sm font-lighr text-black dark:text-gray-300">
                            <div
                                ...
                                <input wire:click="statusChange(6)" id="status3" type="radio" value="3" name="status"
                                       class="w-4 h-4 text-green-700 bg-gray-100 border-gray-300 mr-2" @if($status == 6) checked @endif>
                                На утверждении
                            </div>
                        </label>
                    </li>
                        ...
                        <label class="cursor-pointer w-full text-sm font-lighr text-black dark:text-gray-300">
                            <div
                                ...
                                <input wire:click="statusChange(4)" id="status4" type="radio" value="3" name="status"
                                       class="w-4 h-4 text-green-700 bg-gray-100 border-gray-300 mr-2" @if($status == 4) checked @endif>
                                Корзина
                            </div>
                        </label>
                    </li>
