    ...
    <div
      ...
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        <h1
          ...
          <img class="m-auto" src="{{ Vite::asset('resources/images/logo.svg') }}" alt="Kulinarenok">
        </h1>
        <form class="space-y-4 md:space-y-6" action="{{ route('authenticate') }}" method="POST">
          ...
          <div>
            ...
            <input type="email" name="email" id="email"
              ...
              placeholder="email" required="" value="nurik@mail.ru">
          </div>
          <div>
          ...
          <button type="submit"
            class="w-full text-lg text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">войти</button>
